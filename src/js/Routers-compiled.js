        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactRouter.Route,
                    { path: '/', component: _enter2.default },
                    ...
                    _react2.default.createElement(
                        _reactRouter.Router,
                        { path: 'container' },
                        _react2.default.createElement(_reactRouter.Route, { path: 'home(/:homeUser)', component: _HomeContainer2.default }),
                        _react2.default.createElement(_reactRouter.Router, { path: 'selIndustry(/:userId)', component: _SeleteIndustry2.default }),
                        _react2.default.createElement(_reactRouter.Route, { path: 'movie(/:homeUser)', component: _MovieContainer2.default }),
                        _react2.default.createElement(_reactRouter.Route, { path: 'about(/:region)', component: _AboutContainer2.default }),
                        _react2.default.createElement(_reactRouter.Route, { path: 'find(/:instryName)', component: _FindOrganize2.default }),
                        _react2.default.createElement(_reactRouter.Route, { path: 'finresult/:strMessage', component: _FindOriginResult2.default }),
                        _react2.default.createElement(_reactRouter.Route, { path: 'downstream(/:homeUser)', component: _Downstream2.default }),
