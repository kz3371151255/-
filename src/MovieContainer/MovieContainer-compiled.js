...
var HomeContainer = function (_Component) {
    ...
    function HomeContainer(props) {
        ...
        _this.fetch = function (message) {
            ...
            promise.then(function (json) {
                ...
                if (_this.props.params.homeUser && JSON.parse(_this.props.params.homeUser).industryId) {
                    ...
                    industrySelect.region = _this.state.region;
        ...
        _this.handleSeleteIndustry = function () {
            ...
            travelSelect.type = 0;
            var travelStr = JSON.stringify(travelSelect);
            _reactRouter.browserHistory.push('/container/selIndustry/' + travelStr);
        };
    ...
    _createClass(HomeContainer, [{
        ...
        value: function componentWillMount() {
            ...
            var travel = new Object(); // 页面初始化的时候,就要的保证传递的组织类型 ，只有在选择的找上游的时候，类型才会发生改变
            travel.type = 0;
...
//# sourceMappingURL=MovieContainer-compiled.js.map