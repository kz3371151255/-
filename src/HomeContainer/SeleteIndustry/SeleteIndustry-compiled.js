...
var SeleteIndustry = function (_Component) {
    ...
    function SeleteIndustry(props) {
        ...
        _this.handleDetailIndustry = function (value, index) {
            ...
            return _react2.default.createElement(
                'div',
                { onClick: _this.handleSetIndustry.bind(_this, value.industryId, value.industryName), className: index == _this.state.setIndustryArr.length - 1 ? 'detailBorderNone' : 'detailIndustry', key: index },
                value.industryName
            );
        };
    ...
    _createClass(SeleteIndustry, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'concernedIdustry' },
                _react2.default.createElement(
                    'div',
                    { className: 'concernedSelect', onClick: this.handleChangeButtton },
                    '\u4ECE\u5173\u6CE8\u884C\u4E1A\u4E2D\u8FDB\u884C\u9009\u62E9',
                    _react2.default.createElement('span', { className: this.state.changShow ? 'concernedShow' : 'conceredHidden' })
                ),
                _react2.default.createElement(
                    'div',
                    { className: this.state.changShow ? 'handleDetailShow' : 'handleDetailHidden' },
                    this.state.setIndustryArr.map(this.handleDetailIndustry)
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'totalIndustry', onClick: this.handleTotalButton },
                    '\u4ECE\u5168\u90E8\u884C\u4E1A\u4E2D\u9009\u62E9',
                    _react2.default.createElement('span', { className: this.state.totalShow ? 'totalShow' : 'totalHidden' })
                ),
                _react2.default.createElement(
                    'div',
                    { className: this.state.totalShow ? 'industryMenuShow' : 'industryMenuHidden' },
                    JSON.parse(this.state.local).map(function (value, index) {
                        return _react2.default.createElement(
                            _levelMenu.Card,
                            {
                                key: index,
                                ...
                                content: _react2.default.createElement(
                                    'p',
                                    { style: { height: '4rem', lineHeight: '4rem', paddingLeft: '2.42rem', backgroundColor: '#FFFFFF', fontSize: '1.33rem', overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' } },
                                    value.instryName
                                ),
                                ...
                                return _react2.default.createElement(
                                    ...
                                    val.industryList.map(function (vv, ii) {
                                        ...
                                        return _react2.default.createElement(_levelMenu.Card, {
                                            ...
                                            content: _react2.default.createElement(
                                                'p',
                                                { key: ii, style: { height: '4rem', lineHeight: '4rem', borderBottom: '1px solid #E1E1E1', textIndent: '3rem', fontSize: '1.33rem', color: '#666666', overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' } },
                                                vv.instryName
                                            ),
