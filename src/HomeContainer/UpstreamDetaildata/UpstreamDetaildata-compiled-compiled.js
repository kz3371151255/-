...
var UpstreamDetaildata = function (_Component) {
    ...
    function UpstreamDetaildata(props) {
        ...
        _this2.handleUpStreamDetail = function (item, index) {
            ...
            return _react2.default.createElement('div', { className: 'upStreamDetailOrgin', key: item && item.orgId, onClick: _this2.getLianDataCard.bind(_this2, item.orgPortrait, item.orgId, item.orgRelationType, item.orgType, item.orgShortName, item.orgFullName, '', '', item.orgIndustry, item.orgNetFlag) }, _react2.default.createElement('div', { className: 'upStreamImage', style: { background: 'url(' + orgPortrait + ') no-repeat center center' } }), _react2.default.createElement('span', null, item.orgShortName), _react2.default.createElement('div', { className: 'upStreamaddress' }, item.officeAddressName), _react2.default.createElement('b', null), _react2.default.createElement('div', { className: 'upStreamclassBorder' }));
        };

        _this2.handleUpstream = function () {

            return _react2.default.createElement('div', { className: 'upStreamDetailContainer', ref: 'scroll_container' }, _this2.state.responseArr.map(_this2.handleUpStreamDetail));
        };

        _this2.handleResponseEmpty = function () {
            return _react2.default.createElement('div', { className: 'upStreamResponEmpty' }, _react2.default.createElement('div', { className: 'upStreamImage' }, _react2.default.createElement('img', { src: require('../../images/empty.png'), alt: '' }), _react2.default.createElement('span', null, "\u6682\u65E0\u641C\u7D22\u7ED3\u679C")));
        };
...
//# sourceMappingURL=UpstreamDetaildata-compiled-compiled.js.map