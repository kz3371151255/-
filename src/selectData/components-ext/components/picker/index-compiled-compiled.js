...
var Picker = function (_React$Component) {
  ...
  _createClass(Picker, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'ui-picker-wrapper' }, _react2.default.createElement('div', { className: 'ui-picker',
        style: this.state.style.transform ? this.state.style : style,
        onTouchStart: this.handleTouchStart.bind(this),
        onTouchMove: this.handleTouchMove.bind(this),
        onTouchEnd: this.handleTouchEnd.bind(this) }, this.props.data.list.map(function (data, index) {
        var displayValue = _this2.props.data.displayValue(data);
        return _react2.default.createElement('div', { key: index,
          className: 'ui-picker-item ' + _this2.getSelectedClass(index) }, displayValue);
