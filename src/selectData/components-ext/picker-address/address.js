...
export const provins = [
  ...
  '西藏','陕西省','甘肃省','青海','宁夏','新疆维吾尔自治区','台湾省','香港特别行政区','澳门特别行政区'
];
...
export const citys = {
  ...
  '新疆维吾尔自治区':['- -','乌鲁木齐市','克拉玛依市','吐鲁番地区','哈密地区','昌吉回族自治州','博尔塔拉蒙古自治州','巴音郭楞蒙古自治州','阿克苏地区','克孜勒苏柯尔克孜自治州','喀什地区','和田地区','伊犁哈萨克','塔城地区','阿勒泰地区','石河子市','阿拉尔市','图木舒克市','五家渠市'],
  '台湾省':['- -'],
  '香港特别行政区':['- -'],
  '澳门特别行政区':['- -']
};
