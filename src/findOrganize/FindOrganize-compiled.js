    ...
    function FindOrganize(props) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'userHistory',
                            onClick: _this2.handleHistoryRecord.bind(_this2, value.keyword, value.industryId, value.region) },
                        value.keyword
                    ),
                    _react2.default.createElement('div', { className: arrList > index ? 'historyBorder' : '' })
                );
            }
        ...
        _this2.handleStart = function () {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: _this2.handleKeyup },
                    _react2.default.createElement(
                        'div',
                        { className: 'top_Serach' },
                        _react2.default.createElement(
                            'div',
                            { className: 'searchChange' },
                            _react2.default.createElement('span', null),
                            _react2.default.createElement('input', { autoFocus: true, ref: 'keyword', type: 'search', placeholder: '\u8BF7\u8F93\u5165\u7EC4\u7EC7\u540D\u79F0',
                                value: _this2.state.keyword, onChange: _this2.handleInput })
                        ),
                        _react2.default.createElement(
                            'span',
                            { onClick: _this2.handleHeighLevel },
                            '\u53D6\u6D88'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'industry', onClick: _this2.handleIndustry },
                            _react2.default.createElement(
                                'span',
                                null,
                                ' \u884C\u4E1A\u7C7B\u578B '
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'industry', onClick: _this2.handleRrgion },
                            _react2.default.createElement(
                                'span',
                                null,
                                '\u5730\u533A'
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'searchBtn', onClick: _this2.handleSearch.bind(_this2, false) },
                        '\u641C\u7D22'
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        localStorage.getItem('userHistory') == null ? '' : JSON.parse(localStorage.getItem('userHistory')).map(_this2.handleHistory)
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: _this2.state.clearecord ? 'empty' : 'emptyNone', onClick: _this2.handleEmpty },
                        '\u6E05\u7A7A\u641C\u7D22\u8BB0\u5F55'
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: _this2.state.handleSearchEmpty ? 'handleSearchEmpty' : 'handleSearchnone' },
                        '\u8BF7\u586B\u5199\u641C\u7D22\u6761\u4EF6'
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: _this2.state.clearecord ? 'changNone' : 'changeTrans' },
                        '\u5DF2\u6E05\u9664'
                    )
                )
            );
