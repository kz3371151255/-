		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'slide-ul', style: slideStyle, onTouchStart: function onTouchStart(e) {
					...
					this.state.continuous ? _react2.default.createElement(_Sliders2.default, { sliderIndex: this.props.slider, link: opts[opts.length - 1].link, src: opts[opts.length - 1].src, picWidth: this.state.baseWidth }) : "",
					sliders,
					this.state.continuous ? _react2.default.createElement(_Sliders2.default, { sliderIndex: this.props.slider, link: opts[0].link, src: opts[0].src, picWidth: this.state.baseWidth }) : ""
				),
				_react2.default.createElement(
					'div',
					{ className: 'dots-wrap' },
