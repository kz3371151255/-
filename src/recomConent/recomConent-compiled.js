    ...
    function RecomConent(props) {
        ...
        _this2.handleOrign = function () {
            return _react2.default.createElement(
                'div',
                { className: 'noneOrginRecom' },
                _react2.default.createElement(
                    'div',
                    { className: 'noneOrginImage', ref: 'scroll_container' },
                    _react2.default.createElement('img', { src: require('../images/noneOrign.png'), alt: '' }),
                    _react2.default.createElement(
                        'span',
                        null,
                        '\u6682\u65E0\u63A8\u8350\u7EC4\u7EC7'
        ...
        _this2.handelRender = function (item) {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'RecomComponent', key: item && item.orgId, onClick: _this2.getLianDataCard.bind(_this2, item.orgPortrait, item.orgId, item.orgRelationType, item.orgType, item.orgShortName, item.orgFullName, '', '', item.orgIndustry, item.orgNetFlag) },
                _react2.default.createElement('div', { className: 'componentImage', style: { background: 'url(' + orgPortrait + ') no-repeat center center' } }),
                _react2.default.createElement(
                    'span',
                    null,
                    item.orgShortName
        ...
        _this2.handleRecomContent = function () {
            return _react2.default.createElement(
                'div',
                { className: 'recomConented', ref: 'scroll_container' },
