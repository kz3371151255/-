                ...
                <div className='upStreamTopbox'>
                    ...
                    <div className='default'>
                        <div className='default_left whitepoint'>
                            <span style={{overflow: 'hidden', display:'block', whiteSpace:'nowrap', textOverflow:'ellipsis',fontSize:'18px',color: '#999'}}>{this.state.setUpstreamIndustry == ''?'全部':this.state.setUpstreamIndustry}</span>
                        </div>
                        <div className='streamBorder'></div>
                        <div className='default_right'>
                            <span style={{overflow: 'hidden', display:'block', whiteSpace:'nowrap', textOverflow:'ellipsis',fontSize:'18px',color: '#999'}}>{this.state.region == ''?'全国':this.state.region}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className={this.state.rotateRegion?'responseIndustryBlock':'responseIndustryNone'}>
                    <div className='RegionSet'>
                        <div className='RegionSetContainer'>
                            <div onClick={this.handleCountry}   style={{width:this.state.fathContainerWidth,background:this.state.backgroundColor,height:'3.67rem',lineHeight:'3.67rem',color:this.state.fontSizecolor,fontSize:'1.17rem',textIndent:'1rem',borderBottom:'1px solid #e1e1e1',fontSize:'24px'}}>全国</div>
                            {
                                JSON.parse(this.state.local).map((value,indexs)=>{
                                    return (
                                        <Region
                                            key={indexs}
                                            index = {indexs} //当前索引
