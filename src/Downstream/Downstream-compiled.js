...
require('../HomeContainer/Home/Home.css');
...
var _UpstreamDetaildata = require('../HomeContainer/UpstreamDetaildata/UpstreamDetaildata.js');
...
var Downstream = function (_Component) {
    _inherits(Downstream, _Component);

    function Downstream(props) {
        _classCallCheck(this, Downstream);

        var _this = _possibleConstructorReturn(this, (Downstream.__proto__ || Object.getPrototypeOf(Downstream)).call(this, props));
        ...
        _this.handleCorresponding = function (value, index) {
            ...
            if (value != null) {
                return _react2.default.createElement(
                    'div',
                    { className: 'UpstreamIndustryContainer' },
                    _react2.default.createElement(
                        'div',
                        { className: 'UpstreamIndustry', key: index, onClick: _this.handleSelectUpStream.bind(_this, value.industryId, value.industryName) },
                        value.industryName
                    )
                );
            }
        ...
        _this.handleSeleteIndustry = function () {
            ...
            if (!JSON.parse(userProps).userId) {
                userId = JSON.parse(_this.props.params.homeUser).userId;
                /*userId = 10382*/
            }
            ...
            DownObj.type = 2;
            var DownStr = JSON.stringify(DownObj);
            _reactRouter.browserHistory.push('/container/selIndustry/' + DownStr);
        };
        ...
        _this.handelUpstream = function () {
            ...
            if (_this.state.upStreamNumber == 1 || _this.state.rotateArr) {
                // 当第一次放松请求rotateArr 还是false ,所以用 upStreamNumber=1 标记开始
                _this.fetchUpstream();
            }
    ...
    _createClass(Downstream, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            //通过路由传递 userId,用户的useId 肯定是有的
            var downObj = new Object(); // 页面初始的时候就要保证 类型
            downObj.type = 2;
            this.setState({ setIndustryArr: downObj });

            document.title = '找下游';
            var userProps = JSON.stringify(this.props.location.query);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            this.state.setIndustry
                        ),
                        ' ',
                        _react2.default.createElement(
                            'span',
                            { onClick: this.handleSeleteIndustry },
                            '\u9009\u62E9\u884C\u4E1A'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: this.state.rotateArr ? 'rotateUp' : 'rotateDown', onClick: this.handelUpstream },
                            '\u5BF9\u5E94\u4E0A\u6E38\u884C\u4E1A  '
                        ),
                        _react2.default.createElement(
                            'span',
                            { className: this.state.rotateRegion ? 'regionUp' : 'regionDown', onClick: this.regionUpstream },
                            '\u5730\u533A'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'default_left whitepoint' },
                            _react2.default.createElement(
                                'span',
                                { style: { overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' } },
                                this.state.setUpstreamIndustry == '' ? '全部' : this.state.setUpstreamIndustry
                            )
                        ),
                        _react2.default.createElement('div', { className: 'streamBorder' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'default_right' },
                            _react2.default.createElement(
                                'span',
                                { style: { overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' } },
                                this.state.region == '' ? '全国' : this.state.region
                            )
                        )
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: this.state.rotateArr ? 'responseIndustryBlock' : 'responseIndustryNone' },
                    _react2.default.createElement(
                        'div',
                        { className: 'resopnseIndustry' },
                        this.state.CorrespondingIndustry.length < 1 ? '' : this.state.CorrespondingIndustry.map(this.handleCorresponding)
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: this.state.rotateRegion ? 'responseIndustryBlock' : 'responseIndustryNone' },
                    _react2.default.createElement(
                        'div',
                        { className: 'RegionSet' },
                        _react2.default.createElement(
                            'div',
                            { className: 'RegionSetContainer' },
                            _react2.default.createElement(
                                'div',
                                { onClick: this.handleCountry, style: { width: this.state.fathContainerWidth, background: this.state.backgroundColor, height: '3.67rem', lineHeight: '3.67rem', color: this.state.fontSizecolor, fontSize: '1.17rem', textIndent: '1rem', borderBottom: '1px solid #e1e1e1' } },
                                '\u5168\u56FD'
                            ),
                            _region.RegionData.map(function (value, indexs) {
                                return _react2.default.createElement(
                                    _Region.Region,
                                    {
                                        key: indexs,
                                        ...
                                        , content: _react2.default.createElement(
                                            'p',
                                            { style: { height: '3.63rem', borderBottom: _this2.state.borderDisplay, lineHeight: '3.63rem', textIndent: '1rem', overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' } },
                                            value.fullname
                                        ),
                                    ...
                                    value.areaList.map(function (val, ind) {
                                        ...
                                        return _react2.default.createElement(
                                            'div',
                                            null,
                                            _react2.default.createElement(_Region.Region, {
                                                key: ind,
                                                index: ind,
                                                ...
                                                content: _react2.default.createElement(
                                                    'p',
                                                    { style: { height: '3.63rem', lineHeight: '3.63rem', borderBottom: _this2.state.onLevel, textIndent: '1.08rem', overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis', borderLeft: '1px solid #e1e1e1' }, onClick: _this2.handleTwoLevel.bind(_this2, ind, val.id, val.fullname, val.areaList.length) },
                                                    val.fullname
                                                ),
                            ...
                            _react2.default.createElement(
                                'div',
                                { style: { position: 'absolute', top: '0rem', right: '0px', width: '33.3%', height: '28rem', overflowY: 'scroll', overflowScrolling: 'touch', background: '#fff', display: this.state.regiondisplay, borderLeft: '1px solid #e1e1e1' } },
                                '   ',
                                _react2.default.createElement(
                                    'div',
                                    { style: style.threeLevelRegion, onClick: this.handleThreeLevel },
                                    '\u5168\u90E8'
                                ),
                                this.state.regionDetail ? this.state.regionDetail.map(function (val, index) {

                                    var FontColor = null; //点击当前当前颜色变蓝色 其他还是黑色
                                    _this2.state.currentIndex == index ? FontColor = '#00A0E9' : FontColor = '#333';
                                    return _react2.default.createElement(
                                        'div',
                                        { key: index, style: { height: '3.63rem', lineHeight: '3.63rem', borderBottom: '1px solid  #e1e1e1', textIndent: '1rem', color: _this2.state.threeLevelCurrentFontColor || FontColor, overflow: 'hidden', display: 'block', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }, onClick: _this2.handleCurrentIndex.bind(_this2, index, val.id, val.fullname) },
                                        val.fullname
                                    );
                                }) : ""
                            )
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'upStreamDetail' },
                    _react2.default.createElement(_UpstreamDetaildata2.default, { upStreamArr: this.state.setIndustryArr })
                )
            );
        }
    }]);
...
exports.default = Downstream;

//# sourceMappingURL=Downstream-compiled.js.map