    ...
    function AboutContainer(props) {
        ...
        _this.handleUserMasker = function () {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'top_SerachDetail' },
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(
                                'div',
                                { className: 'SearchDetailContiner' },
                                _react2.default.createElement('span', null),
                                _react2.default.createElement('input', { autoFocus: true, ref: 'keyword', type: 'search', placeholder: '\u8BF7\u8F93\u5165\u884C\u4E1A\u7C7B\u578B', value: _this.state.keyword,
                                    onChange: _this.handleInputAbout })
                            ),
                            _react2.default.createElement(
                                'span',
                                { onClick: _this.handlecancleMasks },
                                '\u53D6\u6D88'
                            )
                        )
                    )
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_AboutDetailIndustary2.default, { item: _this.state.submit })
                )
            );
        };
        ...
        _this.handleuserIndustry = function () {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'findSearch' },
                    _react2.default.createElement(
                        'div',
                        { className: 'findbox' },
                        _react2.default.createElement('span', null),
                        ' ',
                        _react2.default.createElement('input', { onFocus: _this.handleFocus, ref: 'industrySearch', type: 'search', placeholder: '\u8BF7\u8F93\u5165\u884C\u4E1A\u7684\u7C7B\u578B' })
                    ),
                    _react2.default.createElement(
                        'span',
                        { onClick: _this.handleJumpUp },
                        '\u53D6\u6D88'
                    )
                ),
                _react2.default.createElement(
                    ...
                    JSON.parse(_this.state.local).map(function (value, index) {
                        return _react2.default.createElement(
                            _levelMenu.Card,
                            {
                                key: index,
