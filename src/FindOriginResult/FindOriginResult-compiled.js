    ...
    function RecomConent(props) {
        ...
        _this2.handleOrign = function () {
            return _react2.default.createElement(
                'div',
                { className: 'FindOriginnoneOrgin' },
                _react2.default.createElement(
                    'div',
                    { className: 'FindOriginnoneOrginImage', ref: 'scroll_container' },
        ...
        _this2.handelRender = function (item) {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'findComponent', key: item && item.orgId, onClick: _this2.getLianDataCard.bind(_this2, item.orgPortrait, item.orgId, item.orgRelationType, item.orgType, item.orgShortName, item.orgFullName, '', '', item.orgIndustry, item.orgNetFlag) },
                _react2.default.createElement('div', { className: 'componentImage', style: { background: 'url(' + orgPortrait + ') no-repeat center center', backgroundSize: '3.33rem 3.33rem' } }),
                _react2.default.createElement(
                    'span',
                    null,
                    item.orgShortName
